        ...
        try {
            const { error } = await supabase
                ...
                .insert([{
                    ...
                    focus: data.focus,
                    notes: '' // Placeholder for future notes field if needed
                }]);
                        ...
                        >
                            ...
                            <div className="grid grid-cols-2 gap-6 mt-8 pt-6 border-t border-slate-800/50">
                                <div>
                                    ...
                                    <div className="flex items-center gap-2">
                                        <p className="text-xl font-black text-white">{athlete.compliance || 0}%</p>
                                ...
                                <div className="text-right">
                                    ...
                                    <p className="text-xs font-black text-slate-400 uppercase tracking-widest">{athlete.lastWorkout || 'None'}</p>
                                </div>
                            </div>
